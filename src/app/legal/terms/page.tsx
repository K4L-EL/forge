...
export const metadata = {
  title: "Terms of Service — ForgeLabs",
  description: "Terms of service for using ForgeLabs products and services.",
};
      ...
      <Section>
        ...
        <ClayCard className="mx-auto max-w-2xl p-8 md:p-10 text-center space-y-6">
          <p className="text-base text-muted-foreground leading-relaxed">
            In the meantime, have a question about our terms?
          </p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <ContactFormModal
              defaultSubject="Terms of Service question"
              trigger={
                <button
                  type="button"
                  className={cn(
