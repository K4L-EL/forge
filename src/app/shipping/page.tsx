...
export const metadata = {
  title: "Shipping — ForgeLabs",
  description: "Shipping information for ForgeLabs test kits.",
};
      ...
      <Section>
        ...
        <ClayCard className="mx-auto max-w-2xl p-8 md:p-10 text-center space-y-6">
          <p className="text-base text-muted-foreground leading-relaxed">
            In the meantime, have a question about delivery of your test kit?
          </p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <ContactFormModal
              defaultSubject="Shipping question"
              trigger={
                <button
                  type="button"
                  className={cn(
