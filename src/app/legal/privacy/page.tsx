...
export const metadata = {
  title: "Privacy Policy — ForgeLabs",
  description: "How ForgeLabs handles your personal and health data.",
};
      ...
      <Section>
        ...
        <ClayCard className="mx-auto max-w-2xl p-8 md:p-10 text-center space-y-6">
          <p className="text-base text-muted-foreground leading-relaxed">
            In the meantime, have a question about how we handle your data?
          </p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <ContactFormModal
              defaultSubject="Privacy question"
              trigger={
                <button
                  type="button"
                  className={cn(
