...
export const metadata = {
  title: "Returns — ForgeLabs",
  description: "Returns and refunds policy for ForgeLabs test kits.",
};
      ...
      <Section>
        ...
        <ClayCard className="mx-auto max-w-2xl p-8 md:p-10 text-center space-y-6">
          <p className="text-base text-muted-foreground leading-relaxed">
            In the meantime, need help with a return? Get in touch and
            we&apos;ll sort it.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <ContactFormModal
              defaultSubject="Return request"
              trigger={
                <button
                  type="button"
                  className={cn(
