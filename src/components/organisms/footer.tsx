            ...
            <div className="flex gap-4">
              {SOCIAL_LINKS.map((social) => (
                ...
                >
                  ...
                  >
                    <path
                      fillRule={social.label === "Instagram" ? "evenodd" : undefined}
                      clipRule={social.label === "Instagram" ? "evenodd" : undefined}
                      d={social.path}
                    />
                  </svg>
                </a>
